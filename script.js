...
function createSubMenu(elmnt) {
	...
	let top = elmnt.getBoundingClientRect().top - document.querySelector("#startmenu").getBoundingClientRect().top - 3;
...
function setWallpaper(name, way, preview) {
	...
	names[currentLang[43]] = "10";
	names[currentLang[44]] = "1";
	names[currentLang[45]] = "13";
	names[currentLang[46]] = "9";
	names[currentLang[47]] = "3";
	names[currentLang[48]] = "8";
	names[currentLang[49]] = "6";
	names[currentLang[50]] = "18";
	names[currentLang[51]] = "2";
	names[currentLang[52]] = "4";
	names[currentLang[53]] = "12";
	names[currentLang[54]] = "5";
	names[currentLang[55]] = "7";
	names[currentLang[56]] = "16";
	names[currentLang[57]] = "14";
	names[currentLang[58]] = "17";
	names[currentLang[59]] = "11";
	names[currentLang[60]] = "15";
	names[currentLang[61]] = "0";

	let repeat = way == currentLang[63] ? "repeat" : "center no-repeat";

    if (preview == true) {
        document.querySelector(".monitorimg").style.background = `url(res/wallpapers/${names[name]}.bmp) ${repeat}`;
    }
    else {
        document.querySelector("#desktop").style.background = `url(res/wallpapers/${names[name]}.bmp) ${repeat}`;
    }
}
